...
function LensCard({ lensName, lensTag, index, addedType, onAdd, lensLinkDb, lensPriceDb, aiReason, aiCaution }: LensCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group rounded-2xl bg-slate-200/90 p-[1.5px] shadow-lg shadow-slate-200/70 transition-all hover:bg-[linear-gradient(90deg,#5fc3e4_0%,#e55d87_100%)] hover:shadow-xl hover:shadow-slate-300/60 dark:bg-white/10 dark:shadow-black/20 dark:hover:bg-[linear-gradient(90deg,#5fc3e4_0%,#e55d87_100%)]"
    >
