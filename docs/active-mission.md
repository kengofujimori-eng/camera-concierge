...
- 現在は旅行・おでかけを interactive decision flow と相談 handoff に引き上げ、主要4シーンの体験を揃えている。
...
現在の優先タスクは、旅行・おでかけを interactive guide から具体的な相談へつなぎ、主要4シーンを一貫した体験として確認できる状態にすること。

今回の方針:

- 旅行・おでかけガイドで、荷物・撮るもの・レンズ交換の条件から候補を切り替える。
- 既存3シーンと同じ `sessionStorage` handoff と相談画面の確認カードを再利用する。
