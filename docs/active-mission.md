...
現在の優先タスクは、Scene Guide を公開βへ進め、軽運用確認を行いながら次の product phase を選ぶこと。
...
- 公開β後は軽運用確認を優先し、家族写真 / 旅行の追加図解は必要性を見て判断する。
- 次の product phase 候補は stable ID pilot、Resolver data connection pilot、Deep Review comparison format。
